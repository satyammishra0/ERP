            ...
            <div class="page-content">
                <div class="container-fluid">
                    ...
                    <button onclick="history.back()" class="btn btn-sm btn-dark waves-effect waves-light d-flex">
                        <i class="bx bx-left-arrow-alt fs-4"></i> Back</button>
                                ...
                                <div class="card-body">
                                    <div class="row mb-4">
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                <h2>
                                                    <?= isset($ResultsList) ? $ResultsList['0']['hm_name'] : "" ?>
                                                </h2>

                                                <!--<a href="javascript:void(0);" class="btn btn-success waves-effect waves-light"><i class="mdi mdi-plus me-2"></i> Add New</a>-->
                                                <h3 class="new-center-heading text-muted mb-0"><?= $report_type == 'ecp' ? "All ECP Reports" : "All SDT Reports" ?></h3>
