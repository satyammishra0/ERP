  ...
  function changeDirection(id) {
    if (
      ...
      document
        ...
        .setAttribute("href", `${APP_URL}/assets/css/bootstrap.min.css`);
      document
        .getElementById("app-style")
        .setAttribute("href", `${APP_URL}/assets/css/app.min.css`);
      sessionStorage.setItem("is_visited", "layout-direction-ltr");
    } else if (
      ...
      document
        .getElementById("bootstrap-style")
        .setAttribute("href", `${APP_URL}/assets/css/bootstrap-rtl.min.css`);
      document
        .getElementById("app-style")
        .setAttribute("href", `${APP_URL}/assets/css/app-rtl.min.css`);
